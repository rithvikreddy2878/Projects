...
To improve the logit regression performance, it's important to understand which variables should be included. 
Step-wise regression helps us select variables - assess model performance by adding variable and compare. 
```{r}
